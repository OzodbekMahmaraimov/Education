  ...
  return (
    <div className='bg-mostBg h-[4rem] px-4 flex items-center justify-between rounded-lg'>
      ...
      <svg xmlns="http://ww w.w3.org/2000/svg" width="28" height="28" viewBox="0 0 32 32" fill="none">
        <path d="M8 24L24 8" stroke="#FFC27A" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M11 8H24V21" stroke="#FFC27A" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
      </button>
    </div>
  )
