...
const OnePage = () => {
  ...
  return (
    ...
    <div id="home" className="absolute top-0"></div>
      <section>
        <div className="flex md:flex-row gap-7 flex-col justify-around container max-w-[1300px] mt-7 mx-auto mt-[7rem]">
          <div className="flex flex-col gap-10 lg:gap-12 ps-5 xl:ps-0 ps-5 justify-center">
            ...
            <form className="xl:w-[75%] w-[90%] py-2 px-5 rounded-[3rem] bg-white flex justify-around sm:justify-between items-center" action="">
              ...
              <input onClick={handleSubmit} className={`${styles.tugma} py-4 px-10 rounded-[12rem] cursor-pointer`} type="submit" />
            </form>
          </div>
          <div>
            <div className="sm:bg-tugmaColor md:m-0 flex justify-center items-center rounded-[45%] md:rounded-full">
              <img className="w-[30rem] md:py-0 py-12 lg:max-w-[27rem]" src={avatar} alt="Onilne Education" />
            </div>
          </div>
        </div>
      </section>
