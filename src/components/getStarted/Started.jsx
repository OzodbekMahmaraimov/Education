...
const Started = () => {
    return (
        <section className='bg-[#2C1F4A] h-auto md:h-screen'>
            <h1 className='text-center text-white font-semibold	text-5xl py-5'>Welcome to our course</h1>
            <section className='flex md:flex-row flex-col w-100 justify-center mt-12 gap-16'>
                <div className="w-full md:mx-0 mx-auto max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    <h5 className="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">Vip plan</h5>
