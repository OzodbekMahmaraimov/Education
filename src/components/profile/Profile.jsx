...
const Profile = ({ name = "John Doe", username = "johndoe", bio = "Frontend Developer", imageUrl = "https://via.placeholder.com/150" }) => {
  return (
    <>
      <div className="max-w-2xl mx-4 cm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm cm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto mt-16 bg-white shadow-xl rounded-lg text-gray-900">
        ...
        <div className="p-4 border-t mx-8 mt-2">
          <button className="w-1/2 block mx-auto rounded-full bg-gray-900 hover:shax1dow-lg font-semibold text-white px-6 py-2">Edit</button>
        </div>
      </div>
    </>
  )
